...
//    u16 bch_code_distance = 6;
    ...
    PolarCode polar_code(n, info_length, is_BEC, epsilon, crc_size, is_subcode, poly, bch_code_distance, q, sigma_sqr);

    double ebno_log_min = 0.50;
    double ebno_log_max = 0.76;
...
//            256,
    ...
    word_error_rate = polar_code.get_word_error_rate(ebno_vec, list_size_arr, min_error_amount, max_runs_amount, sigma_sqr);
